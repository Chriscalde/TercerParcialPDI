...
class MaestroController extends ValidarController
{
    ...
    public function create(Request $request)
    {
        ...
        $result = DB::select('CALL crearNuevoMaestro(?,?,?,?,?,?)', array($plate, $father, $mother, $name, $curp, $idGradoAca));
    ...
    public function update(Request $request)
    {
        ...
        $curp = $this->validateString($request->input('curp'));
        $idGradoAca = $this->validateInt($request->input('idGradoAca'));
        $result = DB::select('CALL editarMaestro(?,?,?,?,?,?,?)', array($id, $plate, $father, $mother, $name, $curp, $idGradoAca));
        return redirect()->action('MaestroController@list');
    }
    ...
    {
        $id = $request->input('id');
        $maestro = DB::select('CALL eliminarMaestro(?)', array($id));
        return redirect()->action('MaestroController@list');
    }
}
